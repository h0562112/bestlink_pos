...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $setup['directlinepay']['url'].'/oneTimeKeys/pay');
...
fwrite($f,'                    -- url path= '.$setup['directlinepay']['url'].'/oneTimeKeys/pay'.PHP_EOL);
fwrite($f,'                    -- send data= '.print_r($PostData,true).PHP_EOL);

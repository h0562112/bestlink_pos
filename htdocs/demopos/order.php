...
<body>
	...
	<div class='order' id='order'>
		...
		<?php
		if(!isset($initsetting['init']['searchbox'])||$initsetting['init']['searchbox']=='0'){//查詢帳單輸入框
		?>
			<div style='width:calc(58% - 1px);height:69px;margin-right:1px;margin-bottom:1px;float:left;overflow:hidden;'>
				<input type='text' style='width:calc(100% - 10px);height:39px;margin:15px 5px;padding:5px 10px;float:left;' placeholder='Search' name='salebarcodee'>
			</div>
		<?php
		}
		else{
		...
		?>
				<div id='salelist' style='width:100%;height:100%;border:1px solid #898989;float:left;background-color: #848284;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;overflow:auto;'>
					<div class='saletitle' style='background-color:#EFEBDE;width:max-content;overflow:hidden;'>
					<div style='width:100%;height:23px;margin:0 1px 1px 0;float:left; font-size: 20px;'>
						BIZDATE:<span class='viewbizdate'></span>	
					</div>	
						<div style='width:97px;'>
							bizdate
			...
			<div id='fun' style='width:calc(42% - 1px);height:calc(20% - 1px);margin-left:1px;margin-top:1px;float:right;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>
				<table style='width:100%;height:100%;'>
					...
					<tr>
						<td style='width:calc(100% / 4);height:calc(100% / 2);'><button id='changecheck' value='反選' style='width:100%;height:100%;' disabled><?php if($buttons1!='-1')echo "<div id='name1'>".$buttons1['name']['salelist3']."</div>"; ?><?php if($buttons2!='-1')echo "<div id='name2'>".$buttons2['name']['salelist3']."</div>";else; ?></button></td>
						<td style='width:calc(100% / 4);height:calc(100% / 2);'><button id='prebizdate' value='前一日' style='width:100%;height:100%;'><?php if($buttons1!='-1')echo "<div id='name1'>".$buttons1['name']['salelist1']."</div>"; ?><?php if($buttons2!='-1')echo "<div id='name2'>".$buttons2['name']['salelist1']."</div>";else; ?></button></td>
						<td style='width:calc(100% / 4);height:calc(100% / 2);'><button id='nextbizdatetemp' value='後一日' style='width:100%;height:100%;'><?php if($buttons1!='-1')echo "<div id='name1'>".$buttons1['name']['salelist2']."</div>"; ?><?php if($buttons2!='-1')echo "<div id='name2'>".$buttons2['name']['salelist2']."</div>";else; ?></button></td>
						<td style='width:calc(100% / 4);height:calc(100% / 2);'><button id='exit' value='離開' style='width:100%;height:100%;'><?php if($buttons1!='-1')echo "<div id='name1'>".$buttons1['name']['salelist8']."</div>"; ?><?php if($buttons2!='-1')echo "<div id='name2'>".$buttons2['name']['salelist8']."</div>";else; ?></button></td>
					</tr>
				</table>
			</div>
				...
				<div id='fun' style='width:100%;height:calc(100% / 4 - 1px);margin-top:1px;float:left;'>
					...
					<script>
						...
						function checkVipStatus() {
							...
							var memButtonContent = memButton.innerText;

							// 檢查 #membutton 元素的內容是否包含指定文字
							if (memButtonContent.includes('(VIP)')) {
								// 如果包含指定文字，將按鈕背景顏色設置為紅色
								memButton.style.backgroundColor = 'green';
							}else if(memButtonContent.includes('一般會員')){
								memButton.style.backgroundColor = 'yellow';
							}else if(memButtonContent.includes('鍍膜客戶')){
								memButton.style.backgroundColor = 'red';
							}else if(memButtonContent.includes('儲值客戶')){
								memButton.style.backgroundColor = 'blue';
							}else if(memButtonContent.includes('鍍膜+儲值客戶')){
								memButton.style.backgroundColor = '';
							}
						}
		...
		<div class='cremem' style='padding:20px;overflow:hidden;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;' title='<?php if($interface1!='-1'&&isset($interface1['name']['crememtitle']))echo $interface1['name']['crememtitle'];else echo '新增會員'; ?>'>
			<table style='width:100%;height:calc(100% - 61px);margin-bottom:1px;'>
				...
				<tr>
					<td><?php if($interface1!='-1'&&isset($interface1['name']['crephonelabel']))echo '車牌';else echo '車牌'; ?></td>
		...
		<div id='outmoney' title='<?php echo $buttons1['name']['billfun24'] ?>' style='overflow:hidden;'>
		
			<?php if ($buttons1['name']['billfun24'] == '會員預約') { ?>
			<div style='width:50%;height:100%;float:left;'>
				...
				<div style='display:none;width:calc(50% - 4px);height:calc(100px - 4px);margin:1px;float:left;position: relative;border:1px solid #89898950;'>
			...
			<div style='width:50%;height:100%;float:left;'>
				<div style='width:100%;float:left;margin:1px 0;display:none;'>
				...
				<div style='width:100%;float:left;margin:1px 0;'>
					<label style='font-size:2vw;'>預約日期：</label><input type='text' id='picbizdateX' name='zcounter' style='float:right;font-size:2vw;width:calc(100% - 10vw);border:1px solid #898989;'>
				</div>
				<div style='width:100%;float:left;margin:1px 0;'>
					<label style='font-size:2vw;text-align:right;'>車牌號碼：</label><input type='text' name='moneytype' style='float:right;font-size:3vw;width:calc(100% - 10vw);border:1px solid #898989;'>
					<input type='hidden' name='moneytype'>
				</div>
				<div style='width:100%;float:left;margin:1px 0;'>
					<label style='font-size:2vw;'>電話：</label><input type='text' name='moneysubtype' style='float:right;font-size:3vw;width:calc(100% - 10vw);border:1px solid #898989;'>
				</div>
				<div style='width:100%;float:left;margin:1px 0;'>
					<label style='font-size:2vw;'>地址：</label><input type='text' name='addr' style='float:right;font-size:3vw;width:calc(100% - 10vw);text-align:right;border:1px solid #898989;' >
				</div>
				<div style='width:100%;float:left;margin:1px 0;display:none;'>

...
if(strlen($_POST['tempban'])==8){
	$xmlAmount->addChild('SalesAmount',round(intval($_POST['tempmoney'])/1.05));
	...
	$xmlAmount->addChild('TaxAmount',intval($_POST['tempmoney'])-intval(round($_POST['tempmoney']/1.05)));
	$xmlAmount->addChild('TotalAmount',$_POST['tempmoney']);
}
else{
	$xmlAmount->addChild('SalesAmount',$_POST['tempmoney']);
	$xmlAmount->addChild('FreeTaxSalesAmount','0');
	$xmlAmount->addChild('ZeroTaxSalesAmount','0');
	$xmlAmount->addChild('TaxType','1');
	$xmlAmount->addChild('TaxRate','0.05');

 ...
 */
    ...
    class QRcode {
        ...
        //----------------------------------------------------------------------
        public static function svg($text, $outfile = false, $level = QR_ECLEVEL_L, $margin = 4) 
        {
            $enc = QRencode::factory($level, 1, $margin);
    ...
    class QRencode {
        ...
        public function encodeSVG($intext, $outfile = false,$saveandprint=false) 
        {
            try {
                ...
                QRimage::svg($tab, $outfile, $this->margin,$saveandprint);

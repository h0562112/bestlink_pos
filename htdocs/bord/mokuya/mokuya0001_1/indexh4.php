...
if($content['bord']['type']=='Horizontal4'){
}
else{
...
echo "<div style='width:640px;height:200px;float:right;overflow:hidden;float:left;background-image:url(\"img/".$content['bord']['type']."/targetcode.png\");'>
		<iframe frameborder='0' src='../../qrcode.php?company=".$content['initial']['company']."&story=".$content['initial']['story']."' scrolling='no' style='width:136px;height:136px;margin:32px 0 0 410px;float:left;'></iframe>
	</div>";

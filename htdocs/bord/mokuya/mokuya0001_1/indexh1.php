...
if($content['bord']['type']=='Horizontal1'){
}
else{
...
echo "<script>
		...
		$(function(){
			var canvas = document.getElementById('imgbutton');
			canvas.addEventListener('touchstart', function (e) {
                document.getElementById(\"imgbutton\").src=\"img/getbutton2.png\";
            });
            canvas.addEventListener('touchend', function (e) {
                document.getElementById(\"imgbutton\").src=\"img/getbutton.png\";
				console.log('success');
				channel.push();
            });
		});
		...
		$(document).ready(function(){
			...
			$('#imgbutton').click(function(){
				$.ajax({
					method:'GET',
					url:'createdocx.php',
					data:{a:'".$content['initial']['company']."',b:'".$content['initial']['story']."'},
...
<iframe id='frame' src='callnum.php?' frameborder='0' style='margin:285px 0 0 180px;'></iframe>
</div>";
echo "<div style='width:306px;height:258px;position:fixed;right:0;background-image:url(\"img/".$content['bord']['type']."/".$content['logo']['image']."\");'>
</div>";
...
echo "<div style='width:640px;height:200px;float:right;overflow:hidden;float:left;'>
		<input type='image' id='imgbutton' src='img/".$content['bord']['type']."/getbutton.png' style='margin:0 0 0 0;' onmousedown='document.getElementById(\"imgbutton\").src=\"img/".$content['bord']['type']."/getbutton2.png\";' onmouseup='document.getElementById(\"imgbutton\").src=\"img/".$content['bord']['type']."/getbutton.png\";'>
	</div>";
echo "<div style='width:640px;height:230px;float:right;overflow:hidden;background-image:url(\"img/".$content['bord']['type']."/".$content['fbid']['image']."\");float:left;'>
		<iframe frameborder='0' src='fbqrcode.php?id=".$content['fbid']['id']."' style='width:136px;height:136px;margin:45px 0 0 98px;float:left;'></iframe>

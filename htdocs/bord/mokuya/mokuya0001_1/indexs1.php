...
if($content['bord']['type']=='Straight1'){
}
else{
...
echo "<div style='width:460px;height:190px;float:right;overflow:hidden;background-image:url(\"img/".$content['bord']['type']."/".$content['fbid']['goodperson']."\");float:left;'>
		<input type='image' id='imgbutton' src='img/".$content['bord']['type']."/getbutton.png' style='margin:5px 0 0 0;' onmousedown='document.getElementById(\"imgbutton\").src=\"img/".$content['bord']['type']."/getbutton2.png\";' onmouseup='document.getElementById(\"imgbutton\").src=\"img/".$content['bord']['type']."/getbutton.png\";'>
	</div>";

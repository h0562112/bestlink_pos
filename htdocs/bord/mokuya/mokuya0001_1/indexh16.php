...
echo "<script>
	...
	echo "// 4. The API will call this function when the video player is ready.
		...
		$(document).ready(function(){
			...
			setInterval(function(){ $('.fblike').attr('src',$('.fblike').attr('src')) }, 3600000);
...
echo "<div style='width:409px;height:95px;background-color:#000000;background-image:url(\"img/".$content['bord']['type']."/".$content['logo']['image']."\");background-position: center center;background-repeat: no-repeat;position: fixed;bottom: 0;left: 0;'>
</div>";
echo "<div class='marquee'  style='width:1511px;height:95px;overflow:hidden;background-image:url(\"img/".$content['bord']['type']."/".$content['marquee']['image']."?".date('His')."\");background-size:100% 100%;position: fixed;bottom: 0;right: 0;'>
		<marquee scrollamount='";echo ($content['marquee']['speed']/274)*1185;echo "' style='font:80px Microsoft JhengHei;line-height:100px;'><font color='".$content['marquee']['color']."'>".$content['marquee']['text']."</font></marquee>
	</div>";
